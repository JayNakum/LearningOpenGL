            ...
            if ((str.find_first_not_of(" \t\r\n") != string::npos) && (str[0] != '#')) {
                ...
                // Also look at demo.txt to get a sense of why things are done this way.
                    ...
                    if (validinput) {
                        ...
                        mat4 tr = glm::transpose(Transform::translate((float)values[0], (float)values[1], (float)values[2]));
                    ...
                    if (validinput) {
                        ...
                        // You might want to use helper functions on top of file.  
                        // Also keep in mind what order your matrix is!
                        mat4 tr = glm::transpose(Transform::scale((float)values[0], (float)values[1], (float)values[2]));
                        rightmultiply(tr, transfstack);
                    }
                }
                else if (cmd == "rotate") {
                    ...
                    if (validinput) {
                        ...
                        // Also keep in mind what order your matrix is!
                        mat3 tr = Transform::rotate((float)values[3], vec3(values[0], values[1], values[2]));
                        rightmultiply(mat4(tr), transfstack);
                    }
                }
